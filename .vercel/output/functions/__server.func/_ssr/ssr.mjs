...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CSc2JiFw.mjs");
...
var manifest = {
	"8bd2aa46c750df84344a5dd7ccd1b4aa6c79a0a0d319b9ee7d75c224bb8aa18b": {
		functionName: "generateTrack_createServerFn_handler",
		importer: () => import("./api-D1P6MNln.mjs")
	},
	"b1b086ca2d8fd36d3d1496ae6b8c82eb5b4035603c5bb731d7a9b17424b00219": {
		functionName: "generateCover_createServerFn_handler",
		importer: () => import("./api-D1P6MNln.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BqZUtwLa.mjs").then((n) => n.t),
